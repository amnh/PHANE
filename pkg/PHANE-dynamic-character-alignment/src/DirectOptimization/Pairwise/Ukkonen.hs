        ...
        updatedBand = do
            ...
            let extendRow i =
                    ...
                    let start0 = max 0 $ i - offset
                        ...
                        internalCell' = internalCell leftElement insertCost i
                    ...
                    in  do
                            ...
                            when (i > prevOffset) $
                                firstCell leftElement insertCost i b0
                            ...
                            if s0 == t0 && s0 > 0
                                then recomputeUntilSame (s0 + 1) >>= writeSTRef t0' . pred
                                    ...
                                    when (s0 <= e0 && e0 > 0) $
                                        recomputeUntilSame (e0 + 1) >>= writeSTRef t0' . pred
