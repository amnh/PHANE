...
{-# SCC tcm2Dλ #-}
{-# INLINE tcm2Dλ #-}
{-# SPECIALIZE tcm2Dλ ∷ (Bits b) ⇒ TCM2Dλ b #-}
{-# SPECIALIZE tcm2Dλ ∷ TCM2Dλ Int #-}
{-# SPECIALIZE tcm2Dλ ∷ TCM2Dλ CUInt #-}
{-# SPECIALIZE tcm2Dλ ∷ TCM2Dλ Word #-}
{-# SPECIALIZE tcm2Dλ ∷ TCM2Dλ Word8 #-}
{-# SPECIALIZE tcm2Dλ ∷ TCM2Dλ Word16 #-}
{-# SPECIALIZE tcm2Dλ ∷ TCM2Dλ Word32 #-}
{-# SPECIALIZE tcm2Dλ ∷ TCM2Dλ Word64 #-}
tcm2Dλ
    ∷ (Bits b)
    ⇒ TCM2Dλ b
tcm2Dλ lhs rhs
...
{-# SCC tcm3Dλ #-}
{-# INLINE tcm3Dλ #-}
{-# SPECIALIZE tcm3Dλ ∷ (Bits b) ⇒ TCM3Dλ b #-}
{-# SPECIALIZE tcm3Dλ ∷ TCM3Dλ Int #-}
{-# SPECIALIZE tcm3Dλ ∷ TCM3Dλ CUInt #-}
{-# SPECIALIZE tcm3Dλ ∷ TCM3Dλ Word #-}
{-# SPECIALIZE tcm3Dλ ∷ TCM3Dλ Word8 #-}
{-# SPECIALIZE tcm3Dλ ∷ TCM3Dλ Word16 #-}
{-# SPECIALIZE tcm3Dλ ∷ TCM3Dλ Word32 #-}
{-# SPECIALIZE tcm3Dλ ∷ TCM3Dλ Word64 #-}
tcm3Dλ
    ∷ (Bits b)
    ⇒ TCM3Dλ b
tcm3Dλ x y z
